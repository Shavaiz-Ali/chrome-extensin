let i=null;const r=()=>{const o=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT,{acceptNode:e=>{const t=e.textContent.trim().length>0,a=!["SCRIPT","STYLE"].includes(e.parentElement.tagName);return t&&a?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_REJECT}}),s=[];let n;for(;n=o.nextNode();)s.push(n);return console.log(s),s},l=(o,s)=>{const n=document.createElement("div"),e=document.createElement("button");n.style.cssText=`
  ...
  cursor: pointer; text-align:center;  -webkit-line-clamp: 3;">${s}</p>
